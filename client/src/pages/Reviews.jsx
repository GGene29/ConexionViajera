			...
			<div className='list'>
				{
					reviews.length > 0 ?
						<>
							...
							<h2 className='reviews__h2'>¡Escribe tu <span className='green'>reseña</span> aquí!</h2>
						</>
					:
						<>
							<div className="empty">Aun no hay reseñas :(</div>
							<h2 className='reviews__h2'>¡Se el primero en <span className='green'>escribir una</span>!</h2>
						</>
				}
			</div>
			<div className="form">
